...
class EditAvatarCameraViewModel @AssistedInject constructor(
    @Assisted private val handle: SavedStateHandle
    ) : ViewModel() {

    @AssistedFactory
    interface Factory :
        BaseForAssistedSavedStateViewModelFactory<EditAvatarCameraViewModel> {
        override fun create(savedStateHandle: SavedStateHandle): EditAvatarCameraViewModel
    }
