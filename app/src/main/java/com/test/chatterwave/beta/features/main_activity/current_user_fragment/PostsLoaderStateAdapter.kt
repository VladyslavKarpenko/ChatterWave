...
import com.chi.interngram.echo.databinding.ItemPostsErrorBinding
import com.chi.interngram.echo.databinding.ItemProgressBinding
...
class PostsLoaderStateAdapter() : LoadStateAdapter<PostsLoaderStateAdapter.ItemViewHolder>() {
    ...
    class ErrorViewHolder internal constructor(
        private val binding: ItemPostsErrorBinding,
    ) : ItemViewHolder(binding.root) {
